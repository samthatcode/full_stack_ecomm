<template>
  <div class="min-h-screen bg-gray-50">
            ...
            <div v-else class="space-y-4">
              ...
              >
                ...
                <div class="space-y-2">
                  ...
                  >
                    <img :src="item.image" :alt="item.name" class="w-12 h-12 sm:w-14 sm:h-14 rounded-lg object-cover flex-shrink-0" />
    ...
    <div v-if="showEditModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div class="bg-white rounded-xl p-4 sm:p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
        <h3 class="text-lg sm:text-xl font-bold text-gray-900 mb-4">Edit Profile</h3>
        <div class="space-y-4">
          <div>
