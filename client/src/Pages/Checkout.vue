<template>
  <div class="min-h-screen bg-background">
    ...
    >
      <div class="text-center">
        ...
        <router-link to="/products">
          <Button
            class="bg-primary hover:bg-primary/90 text-white rounded-xl px-8 py-4 text-lg font-semibold"
          >
            Start Shopping
          </Button>
        </router-link>
    ...
    <div
      ...
      class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12"
    >
      <div
        class="bg-white rounded-2xl p-8 border border-border shadow-lg text-center"
      >
        <div
        ...
        <p class="text-lg text-muted-foreground mb-8 max-w-md mx-auto">
          Thank you for choosing Rufars Foods! Your order is confirmed and will
        ...
        <div class="space-y-3">
          <router-link to="/">
            <Button
              class="w-full bg-primary hover:bg-primary/90 text-white rounded-xl py-4 text-lg font-semibold"
            >
              Back to Home
            </Button>
          </router-link>
    ...
    <div v-else class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-3xl md:text-4xl font-bold text-foreground">Checkout</h1>
      </div>
      ...
      <div class="grid lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div
              class="bg-white rounded-2xl p-6 border border-border shadow-sm"
            >
            ...
            >
              ...
              <!-- Demo Payment Notice -->
              <div
                class="bg-secondary/10 border border-secondary/20 rounded-xl p-4 mb-6"
              >
        ...
        <!-- Order Summary -->
        <div
          class="bg-white rounded-2xl p-6 border border-border shadow-sm h-fit sticky top-8"
        >
          <h2 class="text-2xl font-bold text-foreground mb-6">Order Summary</h2>

          <div
            class="space-y-3 mb-6 pb-6 border-b border-border max-h-64 overflow-y-auto"
          >
            <div
          ...
          <div class="space-y-4 mb-6 pb-6 border-b border-border">
            ...
            <div class="flex justify-between">
              ...
              <span class="font-semibold">
                <span v-if="shipping === 0" class="text-secondary font-bold"
                  >Free</span
                >
          ...
          <!-- Security Badge -->
          <div
            class="flex items-center justify-center gap-2 text-sm text-muted-foreground pt-4 border-t border-border"
          >
